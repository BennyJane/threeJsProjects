...
let earthImg, earthData, earthParticles = new THREE.Object3D(),
    ...
    coneImg = ['./img/lightray.jpg', './img/lightray_yellow.jpg'],
...
function cameraMove(finalPosition) {
    let scaleRadius = 500 / radius / cameraDiv;
    let cameraPosition = camera.position;
    // 添加相机前后运动
    let positions = [
        cameraPosition.x, cameraPosition.y, cameraPosition.z,
        finalPosition.x * scaleRadius, finalPosition.y * scaleRadius, finalPosition.z * scaleRadius,
        finalPosition.x * scaleRadius, finalPosition.y * scaleRadius, finalPosition.z * scaleRadius,
    ];
    ...
    let positionKF = new THREE.NumberKeyframeTrack('.position', [0, 1.5, 2], positions);
    let clip = new THREE.AnimationClip('move', 2, [positionKF]);
